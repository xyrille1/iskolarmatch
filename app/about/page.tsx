...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-[62ch] px-6 py-12">
      <h1 className="font-serif text-4xl font-light leading-tight sm:text-5xl">How it works.</h1>
      ...
      <ol className="mt-8 flex flex-col gap-6">
        ...
        <li>
          <p className="text-xs font-medium uppercase tracking-[0.12em] text-muted">2. See what you qualify for</p>
          <p className="mt-1">
        ...
        <li>
          <p className="text-xs font-medium uppercase tracking-[0.12em] text-muted">3. Apply on the official site</p>
          <p className="mt-1">
