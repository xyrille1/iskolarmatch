...
export const metadata: Metadata = { title: "Terms — Iskolarly" };
      ...
      <main id="main-content" className="flex-1">
        <div className="mx-auto max-w-[62ch] px-6 py-12">
          ...
          <p className="mt-2 text-sm text-muted">
            Plain-language terms for using Iskolarly. By using the site, you agree to what&apos;s below.
          </p>

          <section className="mt-10">
            <h2 className="text-xs font-medium uppercase tracking-[0.12em] text-muted">What Iskolarly is</h2>
            <p className="mt-2">
              Iskolarly is a free, independent tool that helps Filipino students discover scholarships they may
          ...
          <section className="mt-10">
            ...
            <p className="mt-2">
              We may update these terms as the service grows. Continuing to use Iskolarly after a change means you
          ...
          <section className="mt-10">
            ...
            <p className="mt-2">
              Iskolarly is an independent, unofficial tool. We are not affiliated with CHED, DOST-SEI, UniFAST, or
